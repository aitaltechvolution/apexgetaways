        ...
        <div className="container-pad grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="reveal right relative">
            ...
            <div className="absolute -bottom-6 -left-6 p-5 rounded-2xl max-w-xs"
              ...
              <p className="text-xs font-bold mb-1" style={{ color: 'rgba(10,22,40,0.7)' }}>Our Brand Promise</p>
      ...
      <section className="section-pad" style={{ background: '#070D1A' }}>
        <div className="container-pad">
          <div className="text-center mb-14 reveal">
            ...
            <h2 className="font-display font-bold text-white" style={{ fontSize: 'clamp(1.8rem,3vw,2.5rem)' }}>Core Values</h2>
            ...
            <div className="grid md:grid-cols-2 gap-0 rounded-3xl overflow-hidden"
              ...
              <div className="relative overflow-hidden" style={{ minHeight: '480px' }}>
                ...
                <div className="absolute inset-0 pointer-events-none"
                  style={{ background: 'linear-gradient(to right, transparent 60%, rgba(10,22,40,0.9) 100%)' }}/>
              </div>
              ...
              <div className="flex flex-col justify-center p-8 md:p-10"
                ...
                <div className="mb-2">
                  ...
                  <h3 className="font-display font-bold text-white text-3xl mb-1">{BRAND.ceo.name}</h3>
                  <p className="font-semibold mb-5" style={{ color: '#C9A84C' }}>{BRAND.ceo.title}</p>
                  <p className="text-sm leading-relaxed mb-6" style={{ color: 'rgba(255,255,255,0.6)' }}>{BRAND.ceo.bio}</p>
                </div>

                <blockquote className="border-l-2 border-gold pl-4 mb-6 italic text-sm" style={{ color: 'rgba(255,255,255,0.55)' }}>
